...
一个旨在以尽可能简单的方式解释强化学习的项目，通过使用纯 JavaScript 编写的脚本，利用 Q 学习训练一个32 像素 ×32 像素的《飞扬的小鸟》游戏。
脚本js/brain.js是学习逻辑所在之处，并且有大量文档解释了从零开始的基本 Q 学习算法以及它如何在实时场景中应用。
由于所有内容都是用 JS 单独编写的，因此可以在我们的浏览器内部直接训练和测试游戏，完全没有外部依赖。通过访问链接http://nileshsah.github.io/reinforcement-learning-flappybird/，你可以实时见证小鸟如何学会玩这个游戏。¯**(ツ)**/¯
